...
Os números desta página vêm do registro de benchmarks do engine; o espelho público deles está na [página de benchmarks do produto](https://valorbrain.valor.digital/benchmarks). São números de evidência de recuperação, salvo rótulo em contrário — tratá-los como acurácia de resposta é um erro de categoria (veja abaixo).
