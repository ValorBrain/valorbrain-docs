...
Este é o modelo mental sobre o qual a API e as 92 ferramentas MCP se apoiam. Tudo aqui descreve o que o engine realmente faz; o mapa profundo de módulos vive no repositório do engine ([`docs/CONTEXT.md`](https://github.com/agentxagi/valorbrain/blob/main/docs/CONTEXT.md)).
