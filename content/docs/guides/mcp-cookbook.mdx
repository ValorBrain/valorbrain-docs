...
Superfícies de saúde: `index_stats` (distribuição de conteúdo, staleness), `memory_health`, `usage_report` (ops por canal/ferramenta/latência — o mesmo ledger que o REST `/reports/usage` lê), `list_vaults`.
