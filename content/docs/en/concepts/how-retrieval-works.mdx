...
This is the mental model the API and the 92 MCP tools sit on top of. Everything here describes what the engine actually does; the deep module map lives in the engine repo ([`docs/CONTEXT.md`](https://github.com/agentxagi/valorbrain/blob/main/docs/CONTEXT.md)).
...
3. **RRR fusion** — reciprocal-rank fusion merges the legs without needing comparable scores.
